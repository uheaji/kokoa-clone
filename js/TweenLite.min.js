    ...
    var z = [],
      ...
      U = function (t, e, i, s) {
        var r,
          ...
          m = 0;
        for (
          u.start = t, i && (i(u), (t = u[0]), (e = u[1])), u.length = 0, r = t.match(L) || [], n = e.match(L) || [], s && ((s._next = null), (s.blob = 1), (u._firstPT = s)), l = n.length, o = 0;
          l > o;
          o++
        )
          (_ = n[o]),
      ...
      (n.render = function (t, e, i) {
        ...
        if (t >= l)
          ...
          (this._totalTime = this._time = 0),
            ...
            0 > t &&
              ((this._active = !1),
              0 === l && (this._initted || !this.vars.lazy || i) && (h >= 0 && (h !== _ || "isPause" !== this.data) && (i = !0), (this._rawPrevTime = a = !e || t || h === t ? t : _))),
            this._initted || (i = !0);
